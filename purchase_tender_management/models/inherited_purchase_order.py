...
class InheritedPurchaseOrder(models.Model):
    ...
    #     res = super(InheritedPurchaseOrder, self).button_confirm()
    #     if self.requisition_id:
    #         code = self.requisition_id.name
    #         if code:
    #             self.name = str(code) or _(
    #                 'New')
    #     return res
    ...
    def button_confirm(self):
        ...
        number = self.requisition_id.sequence
    ...
    def _compute_partner_ids(self):
        for rec in self:
            ...
            if partners := rec.requisition_id.vendor_ids:
